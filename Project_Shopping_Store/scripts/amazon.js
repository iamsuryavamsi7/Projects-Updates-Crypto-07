...
products.forEach((product) => {
    ...
    <div class="product-container">
        ...
        <img class="product-image"
            src="${product.image}" alt="Alternate Text for Image">
        </div>
        ...
        <img class="product-rating-stars"
            src="images/ratings/rating-${(product.rating.stars) * 10}.png" alt="Alternate Text for Image">
        ...
        <img src="images/icons/checkmark.png" alt="Alternate Text for Image">
        Added
        </div>
